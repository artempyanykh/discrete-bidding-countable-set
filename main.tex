...
Таким образом, первый игрок на каждом шаге игры рандомизирует свои действия в
зависимости от состояния рынка $s$ и истории ставок. Второй игрок, в свою очередь, не
...
%
Далее, обозначим $q^i$ полную вероятность, с которой первый игрок делает ставку $i
...
\begin{proof}\underline{[Лемма~\ref{upper-bound:lemma:vector-payoffs}]}
  ...
  N$. При $n = N + 1$ первый игрок имеет два разумных ответа на $\tauv^k$: ставка $i
