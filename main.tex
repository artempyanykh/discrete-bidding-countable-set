...
Более подробное описание возникающих в рассматриваемой модели случайных блужданий дается в пп. \ref{sec:lower-bound} и \ref{sec:another-optimal-strategy}.
...
\section{Еще одна оптимальная стратегия инсайдера}
\label{sec:another-optimal-strategy}
