...
\abstract{
  ...
  В работе получено решение повторяющейся антагонистической игры неограниченной продолжительности, отвечающей данной модели, для распределений $\p$ с конечной дисперсией.
}
\engabstract{%
...
Эту модель мы будем называть непрерывной.
...
Эту модель мы будем называть дискретной.
...
Множество всевозможных таких распределений обозначим $\MM$.
...
Нижнее и верхнее значение игры $\G(\p)$ обозначим соответственно
\begin{equation*}
  \LowV(\p) =
...
Множества $\MM$ и $\Theta(x)$ являются выпуклыми замкнутыми подмножествами $\LL$.
...
\] 
вместо $L^{k+\beta}_{\infty}(\xiv^*)$ данные равенства обращаются в тождества.
